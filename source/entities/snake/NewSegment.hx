...
class NewSegment extends FlxSprite {
	...
	public static var animData = [
		"ll" => new AnimData("lr", true), "rr" => new AnimData("lr", false), "uu" => new AnimData("ud", true), "dd" => new AnimData("ud", false),
		"lr" => new AnimData("rr", false), "rl" => new AnimData("rr", false, true), "ud" => new AnimData("dd", false),
		"du" => new AnimData("dd", false, false, true), "ur" => new AnimData("dr", false), "ld" => new AnimData("dr", true), "ul" => new AnimData("dl", true),
		"rd" => new AnimData("dl", false), "dr" => new AnimData("ur", false), "lu" => new AnimData("ur", true), "dl" => new AnimData("ul", true),
		"ru" => new AnimData("ul", false),
	];

	public function new(x:Float, y:Float, z:Int, inDir:Cardinal, outDir:Cardinal, shouldBeVisible:Bool) {
		super(x, y);
